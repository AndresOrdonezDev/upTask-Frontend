...
import { updateUserCurrentPassword } from "@/api/ProfileAPI";
...
export default function ChangePasswordView() {
  ...
  const { mutate } = useMutation({
    mutationFn: updateUserCurrentPassword,
  ...
  return (
    <>
      <div className="mx-auto max-w-3xl">
        ...
        <p className="text-xl font-light text-gray-500 mt-2">Utiliza este formulario para cambiar tu password</p>
